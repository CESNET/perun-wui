 ...
 */
public class Wayf2 extends Composite {
	...
	interface WayfUiBinder extends UiBinder<Widget, Wayf2> {
	}
	...
	public Wayf2(String filter, String redirect) {
	...
	public void buildWayfGroups() {
		...
		ArrayList<WayfGroup> wayfGroups = Utils.getWayfGroups();
				...
				if (group.getFeeds() != null && !group.getFeeds().isEmpty()) {
					...
					groupButton.addClickHandler(new ClickHandler() {
						...
						public void onClick(ClickEvent clickEvent) {
							...
							final String redirectUrl = Utils.getWayfSpLogoutUrl() + "?return=" + consolidatorUrl;
