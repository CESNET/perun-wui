 ...
 *
 * Modified version of original GWT's PrefixTree, which allows to set
 * different char as word divider.
 *
...
public class PrefixTree extends AbstractCollection<String> {
	...
	private static class PrefixTreeIterator implements Iterator<String> {
		...
		public native void addTree(PrefixTree tree, String prefix) /*-{
            var suffixes = [];
            for (var suffix in tree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::suffixes) {
            ...
            var frame = {
                ...
                subtrees: tree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::subtrees,
                prefix: prefix,
                index: 0
            };
            var stack = this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree.PrefixTreeIterator::stack;
            stack.push(frame);
        }-*/;
		...
		private native void init() /*-{
            this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree.PrefixTreeIterator::stack = [];
        }-*/;
		...
		private native String nextImpl(boolean peek) /*-{
            var stack = this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree.PrefixTreeIterator::stack;
            var safe = @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::safe(Ljava/lang/String;)
            var unsafe = @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::unsafe(Ljava/lang/String;)
                ...
                if (frame.index < frame.suffixNames.length) {
                    ...
                    if (frame.index < frame.suffixNames.length) {
                        ...
                        for (key in frame.subtrees) {
                            ...
                            this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree.PrefixTreeIterator::addTree(Lcz/metacentrum/perun/wui/widgets/resources/PrefixTree;Ljava/lang/String;)(subtree, target);
                        }
                    }
                    return toReturn;
	...
	public native boolean add(String s) /*-{
        var suffixes =
            this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::suffixes;
        var subtrees =
            this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::subtrees;
        var prefixLength =
            this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::prefixLength;
        ...
        if (s.length <= prefixLength) {
            var safeKey = @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::safe(Ljava/lang/String;)(s);
            if (suffixes.hasOwnProperty(safeKey)) {
                return false;
            } else {
                // Each tree keeps a count of how large it and its children are.
                this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::size++;
                suffixes[safeKey] = true;
                return true;
            }
            // Add the string to the appropriate PrefixTree.
        } else {
            var prefix = @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::safe(Ljava/lang/String;)(s.slice(0, prefixLength));
            var theTree;
            if (subtrees.hasOwnProperty(prefix)) {
                theTree = subtrees[prefix];
            } else {
                theTree = @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::createPrefixTree(I)(prefixLength << 1);
                subtrees[prefix] = theTree;
            }
            var slice = s.slice(prefixLength);
            if (theTree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::add(Ljava/lang/String;)(slice)) {
	...
	public native void clear() /*-{
        this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::size = 0;
        this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::subtrees = {};
        this.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::suffixes = {};
    }-*/;
	...
	protected native void suggestImpl(String search, String prefix,
        ...
        if (search.length > prefix.length + prefixLength) {
            var key = @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::safe(Ljava/lang/String;)(search.slice(prefix.length, prefix.length + prefixLength));
            // Just pick the correct subtree, if it exists, and call suggestImpl.
            if (subtrees.hasOwnProperty(key)) {
                var subtree = subtrees[key];
                var target = prefix + @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::unsafe(Ljava/lang/String;)(key);
                subtree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::suggestImpl(Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;I)(search, target, output, limit);
            }
            ...
            for (var suffix in suffixes) {
                ...
                var target = prefix + @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::unsafe(Ljava/lang/String;)(suffix);
            ...
            for (var key in subtrees) {
                ...
                if (target.indexOf(search) == 0) {
                    ...
                    if ((subtree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::size <= limit - output.@java.util.Collection::size()()) ||
                        (subtree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::size == 1)) {
                        subtree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::dump(Ljava/util/Collection;Ljava/lang/String;)(output, target);
                        // Otherwise, include as many answers as we can by truncating the suffix
                    } else {
                        // Always fully-specify suffixes.
                        for (var suffix in subtree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::suffixes) {
                            if (suffix.indexOf(':') == 0) {
                                output.@java.util.Collection::add(Ljava/lang/Object;)(target + @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::unsafe(Ljava/lang/String;)(suffix));
                            }
                        }
                        // Give the keys of the subtree.
                        for (var subkey in subtree.@cz.metacentrum.perun.wui.widgets.resources.PrefixTree::subtrees) {
                            if (subkey.indexOf(':') == 0) {
                                output.@java.util.Collection::add(Ljava/lang/Object;)(target + @cz.metacentrum.perun.wui.widgets.resources.PrefixTree::unsafe(Ljava/lang/String;)(subkey) + "...");
                            }
                        }
                    }
                }
