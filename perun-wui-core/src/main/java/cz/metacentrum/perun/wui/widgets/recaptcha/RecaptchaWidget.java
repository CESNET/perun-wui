...
public class RecaptchaWidget extends Composite {
	 ...
	 * @param lang     the specific language
	 * @param theme    an specific theme
	 * @param tabIndex the tabIndex of the widget or 0 for default
	 */
	 ...
	 *
	 * @param key               Your public key
	 * @param lang              the specific language, has also to be set for audio output
	 * @param theme             an specific theme
	 * @param tabIndex          the tabIndex of the widget or 0 for default
	 * @param customTranslation a custom translation for the widget's Strings
	 */
	public RecaptchaWidget(String key, String lang, String theme, int tabIndex,
	 ...
	 * @param theme       an specific theme
	 * @param tabIndex    the tabIndex of the widget or 0 for default
	 * @param customTheme the ID of a DOM-Element
	 */
	public RecaptchaWidget(String key, String lang, String theme, int tabIndex,
	                       String customTheme) {
		this.key = key;
	 ...
	 * customTranslation
	 */
	protected void create(String lang, String theme, int tabIndex, RecaptchaTranslation translation) {
		Recaptcha
	 ...
	 */
	protected void create(String lang, String theme, int tabIndex, RecaptchaTranslation translation, String customtheme) {
		Recaptcha.create(key, RECAPTCHA_DIV_ID, theme, lang, tabIndex,
