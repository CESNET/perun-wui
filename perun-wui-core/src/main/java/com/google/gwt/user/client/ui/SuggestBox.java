 ...
 * suggestions. A SuggestBox fires {@link com.google.gwt.event.logical.shared.SelectionEvent SelectionEvents}
...
public class SuggestBox extends Composite implements HasText, HasFocus,
	...
	/**
	 * The callback used when a user selects a {@link com.google.gwt.user.client.ui.SuggestOracle.Suggestion}.
	 */
	...
	public static class DefaultSuggestionDisplay extends SuggestionDisplay
		...
		protected void showSuggestions(final SuggestBox suggestBox,
			...
			Scheduler.get().scheduleDeferred(new Command() {
				@Override
				public void execute() {
					if (scroll.getOffsetWidth() >= 300) {
						scroll.addStyleName("suggestPopupScrollPadding");
					} else {
						scroll.removeStyleName("suggestPopupScrollPadding");
					}
				}
			});
			*/
	...
	/**
	 * Returns a {@link com.google.gwt.editor.client.adapters.TakesValueEditor} backed by the SuggestBox.
	 */
	...
	/**
	 * @deprecated Use the {@link com.google.gwt.event.shared.HandlerRegistration#removeHandler} method on the
	...
	/**
	 * @deprecated Use the {@link com.google.gwt.event.shared.HandlerRegistration#removeHandler} method no the
